...
from api_integrations.yahoo_finance_client import YahooFinanceClient
from api_integrations.alphavantage_client import AlphaVantageClient
from api_integrations.news_client import NewsClient
...
class DataService:
    ...
    def __init__(self):
        ...
        self.news_api = NewsClient(api_key=None)  # Will use the key from config
