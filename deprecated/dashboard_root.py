...
if st.session_state.show_docs:
    ...
    with col1:
        ...
        <div class="feature-box">
            <h3 style="font-size: 1.2rem; margin-bottom: 0.5rem;">📊 Asset Analysis</h3>
            <p>Analyze stocks, crypto, ETFs & REITs with AI-powered insights</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        st.markdown("""
        <div class="feature-box">
            <h3 style="font-size: 1.2rem; margin-bottom: 0.5rem;">🧠 Smart Recommendations</h3>
            <p>Get AI-powered insights & investment recommendations</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col3:
        st.markdown("""
        <div class="feature-box">
            <h3 style="font-size: 1.2rem; margin-bottom: 0.5rem;">📈 Interactive Charts</h3>
            <p>Explore interactive charts & visualizations</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col4:
        st.markdown("""
        <div class="feature-box">
            <h3 style="font-size: 1.2rem; margin-bottom: 0.5rem;">🔄 Asset Comparison</h3>
            <p>Compare multiple assets side by side</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    <div class="getting-started-box">
        <h3 style="color: #4f46e5; margin-bottom: 0.5rem;">Getting Started</h3>
        <ol>
    ...
    # Final message
    st.markdown("The dashboard will provide you with comprehensive analysis, insights, and educational content to help you make informed investment decisions.")
